...
from blocks import EncoderSplit, diDecoder, TransformerLayer, AttnModule,Encoder
...
class GenomeModel(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        output,features = self.decoder(transformed_features)
...
def init_training(args):
    ...
    pl_module = GenomeModel(
        encoder=Encoder(input_cahnnels=5),
        transformer=AttnModule(hidden=256, record_attn=False),

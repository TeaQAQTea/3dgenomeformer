...
class ChromosomeDataset(Dataset):
    ...
    '''
    def __init__(self, celltype_root, chr_name, omit_regions, tad_file,di_file, feature_list, use_aug = True):
    ...
    def __getitem__(self, idx):
        ...
        seq, features, tad, di = self.get_data_at_interval(start, end)
        ...
        if self.use_aug:
            ...
            seq, features, tad,di = self.reverse(seq, features, tad,di)

        return seq, features, tad, di, start, end
    ...
    def reverse(self, seq, features, tad,di, chance = 0.5):
        '''
        ...
        if r_bool < chance:
            ...
            tad_r = tad
            di_r = di
        return seq_r, features_r, tad_r, di_r
    ...
    def get_data_at_interval(self, start, end):
        ...
        # mat = np.log(mat + 1)
        tad = self.tad_file.get(self.chr_name, start, end)
        di = self.di_file.get(self.chr_name, start, end)

        return seq, features, tad, di

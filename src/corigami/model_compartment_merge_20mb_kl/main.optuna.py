...
def objective(trial, args):
    ...
    args.trainer_max_epochs = trial.suggest_int("max_epochs", 50, 500)
    args.dataloader_batch_size = trial.suggest_int("batch_size", 4, 64)
    args.di_weight = trial.suggest_float("di_weight", 0.1, 1.0)
...
class TrainModule(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        criterion_di=torch.nn.BCELoss()
        # outputs_di_log=torch.log(outputs_di+1e-8)
        # print(prob_di)

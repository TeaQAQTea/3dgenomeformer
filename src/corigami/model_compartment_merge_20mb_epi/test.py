...
class TrainModule(pl.LightningModule):
    ...
    def proc_batch(self, batch):
        features,  di, start, end, chr_name, chr_idx = batch
    ...
    def _shared_eval_step(self, batch, batch_idx):
        ...
        outputs_di,attention = self(inputs)
        criterion = torch.nn.MSELoss()
        ...
        return {'loss' : loss,'di_target':di,'di_predict':outputs_di,'start':start,'end':end,'chr_name':chr_name,'chr_idx':chr_idx,'attention':attention}

...
class ChromosomeDataset(Dataset):
    ...
    '''
    def __init__(self, celltype_root, chr_name, omit_regions, di_file, abc_file, feature_list, use_aug = True):
    ...
    def __getitem__(self, idx):
        ...
        seq, features, mat, di,abc = self.get_data_at_interval(start, end)
        ...
        if self.use_aug:
            ...
            seq, features, mat,di,abc = self.reverse(seq, features, mat,di,abc)

        return seq, features, mat, di,abc, start, end
    ...
    def reverse(self, seq, features, mat,di,abc, chance = 0.5):
        '''
        ...
        if r_bool < chance:
            ...
            di_r = di
            abc_r=abc
        return seq_r, features_r, mat_r, di_r,abc_r
    ...
    def get_data_at_interval(self, start, end):
        ...
        abc = self.abc_file.get(self.chr_name, start, end)
        return seq, features, mat, di, abc

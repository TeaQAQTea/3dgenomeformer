...
>>>>>>> backup/old-main
    ...
    def __getitem__(self, idx):
        ...
        seq, features, mat, di = self.get_data_at_interval(start, end)
        ...
        if self.use_aug:
            ...
            seq, features, mat,di = self.reverse(seq, features, mat,di)

        return seq, features, mat, di, start, end
    ...
    def reverse(self, seq, features, mat,di, chance = 0.5):
        '''
        ...
        if r_bool < chance:
            ...
            mat_r = mat
            di_r = di
        return seq_r, features_r, mat_r, di_r
...
=======
        ...
        intervals = intervals_bin * self.res
        if intervals[-1, 1] > len(self.seq):
        # 调整最后一个区间，使其结束位置不超过序列长度

...
class CellLineDataset(Dataset):
    ...
    def __init__(self, cell_lines,  # Cell line names as a list
                 ...
                 resolution=4096,
                 cool_res=4096,
                 target_treatment='log',
                 use_weight=False,
                 clip_pc=95,
                 use_aug=True):
        self.sample_length = sample_length
        self.resolution = resolution
        self.cool_res = cool_res
    ...
    def __getitem__(self, idx):
        ...
        seq, features, mat, start, end,weight = self.cell_line_datasets[dataset_idx].chr_data[chr_name][chr_idx]
    ...
    def load_cell_line_datasets(self, mode):
        ...
        for cell_line in self.cell_lines:
            ...
            dataset = GenomeDataset(celltype_root=cell_line_path, 
                                    ...
                                    cool_res=self.cool_res,
                                    target_treatment=self.target_treatment,
                                    use_weight=self.use_weight,
                                    clip_pc=self.clip_pc,

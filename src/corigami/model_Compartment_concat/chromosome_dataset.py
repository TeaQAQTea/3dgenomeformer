...
class ChromosomeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        seq, features,  di = self.get_data_at_interval(start, end)
        ...
        if self.use_aug:
            ...
            seq, features, di = self.reverse(seq, features, di)

        return seq, features,  di, start, end
    ...
    def reverse(self, seq, features, di, chance = 0.5):
        '''

...
class Encoder(nn.Module):
    def __init__(self, in_channel, output_size = 256, filter_size = 5, num_blocks = 11):
        ...
        hiddens =        [32, 32, 32, 32, 64, 64, 128, 128, 128, 256, 256]
        hidden_ins = [32, 32, 32, 32, 32, 64, 64, 128,  128, 128, 256]
